...
class UI:
    ...
    def create_edgeless_graph(self):
        ...
        try:
            self.graph = UndirectedGraph(int(n))
    ...
    def create_random_graph(self):
        ...
        try:
            self.graph = UndirectedGraph(int(n), int(m))
            print("UndirectedGraph Created")
    ...
    def start(self):
        ...
        while True:
            ...
            print("17. Construct the minimal spanning tree using Kruskal's Algorithm")
            print("0. Exit")
